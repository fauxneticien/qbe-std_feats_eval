...
parser.add_argument('dtw_results_csv', help='name of results CSV file to process in dtw_results_dir')
...
dtw_results_csv   = os.path.join(args.dtw_results_dir, args.dtw_results_csv)
...
fbeta_results_csv = os.path.join(args.fbeta_results_dir, "f{}_{}".format(beta, args.dtw_results_csv))
