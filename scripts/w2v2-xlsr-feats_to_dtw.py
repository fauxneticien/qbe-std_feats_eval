...
for dataset in datasets:
    ...
    for features in extracted_feats:
        ...
        queries_pkl    = os.path.join(args.feats_dir, dataset, features, dataset, args.queries_file)
        references_pkl = os.path.join(args.feats_dir, dataset, features, dataset, args.references_file)
        ...
        def dtw_by_row(row_number):
            ...
            # print(np.array(query_feats_matrix).shape, np.array(reference_feats_matrix).shape)
